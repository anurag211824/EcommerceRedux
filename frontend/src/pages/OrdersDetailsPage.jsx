            ...
            <div className="flex flex-col sm:flex-row justify-between mb-8">
                ...
                <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
                  <span className={`${orderDetails.isPaid ? "bg-green-100 text-green-600" : "bg-red-100 text-red-700"} px-3 py-1 rounded-full text-sm font-medium mb-2`}>{orderDetails.isPaid ? 'Approved':"Pending"}</span>
                    <span className={`${orderDetails.isDelivered ? "bg-yellow-100 text-yellow-500" : "bg-red-100 text-red-700"} px-3 py-1 rounded-full text-sm font-medium mb-2`}>{orderDetails.isDelivered ? 'Delivered':"Pending"}</span>
                </div>
            </div>
