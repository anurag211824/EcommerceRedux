...
// Async thunk that will fetch the products by Collection and optional filters
...
// Async thunk to update the similar products
...
const productsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // Handling updating product details
      ...
      // Handling FetchSimilar Products
